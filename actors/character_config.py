...
class CharacterProfile:
    ...
    special_setting: str
# 定义多个角色
CHARACTER_NAMES = ["埃勒里·奎因","玛尔博","赛布尔","阿祖尔"]
# 定义多个角色配置
CHARACTER_CONFIGS = {
    ...
    "玛尔博": CharacterProfile(
        ...
        special_setting = "在户外的秘密花园休息过一段时间，准备了一个精美的礼盒，没有人知道这个精美的礼盒里装的是炸弹，一旦拆开就会爆炸，跟别人对话的时候可不能说出来"
    ),
    "赛布尔": CharacterProfile(
        ...
        special_setting = "把一根拐杖糖的末端，吮成了致命的尖角"
    ),
